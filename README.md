...
### Examples
default order is ascending. all algorithms accept a comparison callback as the second param except radix sort that accept the order as a string "asc" or "decs".
