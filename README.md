...
## Contribution
If you'd like to contribute to the project to imrpove the existing algorithms or create new ones, feel free to fork the repo to your github and push your code. It just has to be consistent with the existing code structure and style, as well as tests and README. Once done, please open a PR from development branch. Thanks 🌠
